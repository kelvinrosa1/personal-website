...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Fullstack Web Development Certificate</li>
      </ul>
    ),
  }
]
      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full ">
          ...
          <p className="text-base lg:text-lg">
            ...
            working with JavaScript, React, Node.js, Express, PostgreSQL, HTML,
            CSS, and Git. I am a quick learner and I am always looking to expand
            my knowdledge and skill set. I am a team player and I am excited to
